...
export default function NewSupabaseProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("/api/admin/supabase/products", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-yammy-dark-blue">Add New Product</h1>
          <p className="text-gray-600">Create a new product in your Supabase database</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-4 mt-6">
          ...
          <Button type="submit" disabled={isLoading} className="bg-yammy-blue hover:bg-yammy-dark-blue">
            {isLoading ? (
              <>
